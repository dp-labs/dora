# Reference: https://github.com/triton-lang/triton/blob/main/.github/workflows/llvm-build/centos.Dockerfile
FROM centos:7
...
SHELL [ "/usr/bin/scl", "enable", "devtoolset-7", "rh-python38" ]
