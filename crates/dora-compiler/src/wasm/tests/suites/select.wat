(module
  ...
  (func (export "select-i32") (param i32 i32) (result i32)
    (select (local.get 0) (local.get 1) (i32.const 1))
  )
  (func (export "select-i64") (param i64 i64) (result i64)
    (select (local.get 0) (local.get 1) (i32.const 1))
  )
  (func (export "select-f32") (param f32 f32) (result f32)
    (select (local.get 0) (local.get 1) (i32.const 1))
  )
  (func (export "select-f64") (param f64 f64) (result f64)
    (select (local.get 0) (local.get 1) (i32.const 1))
  )
