...
pub const ERC20_BYTECODE_HEX: &str = include_str!("../../../examples/evm/erc20/contract.hex");
pub const UNISWAP_V2_BYTECODE_HEX: &str =
    include_str!("../../../examples/evm/uniswap_v2/contract.hex");
...
pub fn get_benches() -> Vec<Bench> {
    ...
    vec![
        ...
        // Note: the default wasm entrypoint is `main`, the entry logic generated by different WASM contract toolchains may vary.
        Bench {
            name: "fibonacci-wasm",
            bytecode: include_bytes!("../../../examples/wasm/fibonacci/fib.wasm").to_vec(),
            ..Default::default()
        },
    ]
}
